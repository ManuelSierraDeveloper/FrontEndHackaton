    ...
    <div className="max-w-[1280px] mx-auto px-6 py-20 text-center">
      <div className="max-w-lg mx-auto">
        <div className="w-20 h-20 rounded-2xl bg-[#DEDB8D] flex items-center justify-center mx-auto mb-6">
          <Compass className="w-10 h-10 text-[#6D9E13]" />
        </div>
        <h1 className="font-heading font-bold text-3xl md:text-4xl text-gray-900 mb-4">Experiencias</h1>
        <p className="text-gray-600 mb-8">
          Descubre experiencias de turismo rural en fincas del Magdalena. Conecta con la tierra y sus productores.
        </p>
        <Link
          href="/"
